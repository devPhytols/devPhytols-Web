// Definições básicas para o bot
const renderCard = `<svg width="495" height="195" viewBox="0 0 495 195" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
<style>
    .leftdiv {
...
<g transform="translate(0, 25)">
    ...
    <pattern id="image" x="0%" y="0%" height="100%" width="100%" viewBox="0 0 512 512">
        <image x="0%" y="0%" width="512" height="512"
            xlink:href="data:image/png;base64,IMAGESTRING}">
        </image>
    </pattern>
</defs>
<circle cx="86" cy="44" r="40" stroke="#fff" stroke-width="3" fill="url(#image)" />
    <text x="86" y="100" class="namepl">N/A</text>
    ...
    <text x="114" y="124" style="font-weight: 700" class="followers">N/A</text>
    </g>
    <svg>
        <g transform="translate(230, 0)">
            <g class="singleitem" style="animation-delay: 210ms" transform="translate(25, 0)">
                ...
                <text class="text" style="font-weight: 700" x="150" y="12.5">N/A</text>
            </g>
        </g>
